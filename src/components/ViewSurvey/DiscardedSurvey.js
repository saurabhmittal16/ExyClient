...
import { getDiscardedSurveys, clearSurvey } from '../../actions/surveyActions';
...
class DiscardedSurvey extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            query: '',
    ...
    componentWillMount() {
        this.props.getDiscardedSurveys(this.state.page);
    }
...
const mapStateToProps = (state) => {
    return {
        surveys: state.survey.discardedSurveys,
        pagination: state.survey.discardedPage
    }
}

export default connect(mapStateToProps, { getDiscardedSurveys, clearSurvey })(DiscardedSurvey);